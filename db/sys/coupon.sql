...
(
    ...
    type            int          NOT NULL COMMENT '类型,0:无门槛,1:满减,2:满折,3:随机,4:服务卡卷',
    classify_id     int          NOT NULL DEFAULT -1 COMMENT '限制品类,默认为-1不限制',
    area_code       int          NOT NULL DEFAULT -1 COMMENT '限制地区,默认为-1不限制',
    ...
    description     varchar(1024) COMMENT '规则描述',
...
(
    ...
    type            int          NOT NULL COMMENT '类型,0:无门槛,1:满减,2:满折,3:随机,4:服务卡卷',
    classify        varchar(16)  NOT NULL DEFAULT -1 COMMENT '限制品类,优先使用运营设置的类目，模板次之,默认为-1不限制',
    area_code       int          NOT NULL DEFAULT -1 COMMENT '限制地区,默认为-1不限制',
    ...
    give_start_time bigint       NULL COMMENT '领取开始时间',
    give_end_time   bigint       NULL COMMENT '领取结束时间',
    start_time      bigint       NOT NULL COMMENT '有效开始时间',
    end_time        bigint       NOT NULL COMMENT '有效结束时间',
    package_name    varchar(64)  NOT NULL COMMENT '产品包名',
